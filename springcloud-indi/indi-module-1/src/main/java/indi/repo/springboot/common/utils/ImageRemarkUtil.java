...
public class ImageRemarkUtil {
    ...
    // 水印文字字体
    private static Font font = new Font("宋体", Font.BOLD, 36);
    // 水印文字颜色
    ...
    public static void markImageByText(String logoText, String srcImgPath,
        ...
        try {
            ...
            g.setRenderingHint(RenderingHints.KEY_INTERPOLATION,
                    RenderingHints.VALUE_INTERPOLATION_BILINEAR);
            g.drawImage(
                    srcImg.getScaledInstance(width,
            ...
            g.drawString(logoText, width /2, height /2);
            // 9、释放资源
            g.dispose();
            // 10、生成图片
            os = new FileOutputStream(targerPath);
    ...
    public static void main(String[] args) {
        String srcImgPath = "C:\\Users\\thompson\\Pictures\\12.jpg";
//        String srcImgPath = "C:\\Users\\thompson\\Pictures\\4.png";
        String logoText = "数 易 淘";
        String iconPath = "d:/2.jpg";

        String targerTextPath = "C:\\Users\\thompson\\Pictures\\qie_text.jpg";
